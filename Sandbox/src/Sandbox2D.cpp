...
void Sandbox2D::OnUpdate(Moza::Timestep ts)
{
...

	{
		...
		Moza::Renderer2D::DrawQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, { 0.8f, 0.2f, 0.3f, 1.0f });
		Moza::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Moza::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, { 0.2f, 0.8f, 0.3f, 0.75f }, 2.0f);
		Moza::Renderer2D::DrawQuad({ -0.5f, -0.5f,  0.1f }, { 1.0f, 1.0f }, m_CheckerboardTexture, { 0.7f, 0.2f, 0.3f, 0.75f }, 1.0f);
